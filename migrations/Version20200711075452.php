 ...
 */
final class Version20200711075452 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_DB021E96A4F84F6E ON messages');
        $this->addSql('DROP INDEX UNIQ_DB021E9610335F61 ON messages');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_DB021E96A4F84F6E ON messages (destinataire_id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_DB021E9610335F61 ON messages (expediteur_id)');
    }
}
